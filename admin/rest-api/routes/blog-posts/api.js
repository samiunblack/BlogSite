...
module.exports = {
  ...
  createNewBlogPost: function (title, urlTitle, dateTimestamp, tags, thumbnailImageUrl, thumbnailImageCaption, markdownContent, seoTitleTag, seoMetaDescription, callback) {
  ...
  editBlogPost: function (id, title, urlTitle, dateTimestamp, tags, thumbnailImageUrl, thumbnailImageCaption, markdownContent, seoTitleTag, seoMetaDescription, callback) {
    const arrayOfTags = tags.split(",").map(function (tag) {
      return tag.trim()
    })
