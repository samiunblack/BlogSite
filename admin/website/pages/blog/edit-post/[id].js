...
import getBlogPostId from "../../../api/blog-posts/getPostById"
...
export default class extends Component {
  static async getInitialProps({ req, res, query }) {
    const apiResult = await getBlogPostId(query.id, req)
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      imageCaptionInputValue: post && post.thumbnailImageCaption,
  ...
  updateImageCaptionInputValue = (event) => {
    this.setState({ imageCaptionInputValue: event.target.value })
  }
  ...
  submitEditPostRequest = () => {
    if (!this.state.titleInputValue) {
    ...
    } else if (!this.state.imageCaptionInputValue) {
      this.setState({ submitError: true, errorMsg: "Image Caption field is required." })
      ...
      editBlogPost(
        ...
        this.state.imageCaptionInputValue,
                ...
                <div className="edit-blog-post-form-container">
                  ...
                  <div className="edit-blog-post-form-section">
                    ...
                    <div className="edit-blog-post-form-section-input">
                      <input
                        type="text"
                        value={this.state.imageCaptionInputValue}
                        onChange={this.updateImageCaptionInputValue}
                      />
                    </div>
                  </div>
                  <div className="edit-blog-post-form-section">
